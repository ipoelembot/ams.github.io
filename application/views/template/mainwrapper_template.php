...
<head>
<meta charset="utf-8"/>
<title>Demo Version | Activation Memo System</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Custom Dropdowns <small>select2, selectboxit & multi select examples</small>
			</h3>
			<div class="page-bar">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Bootstrap Select
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
...
<div class="page-footer">
	<div class="page-footer-inner">
		 2019 &copy; PT. Bank Muamalat Indonesia, Tbk.
	</div>
	<!-- syntax untuk icon scroll to up -->
