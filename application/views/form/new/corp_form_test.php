...
<script src="<?php echo base_url();?>ams_components/assets/js/jquery-migrate.min.js" type="text/javascript"></script>
...
<script type="text/javascript" src="<?php echo base_url();?>ams_components/assets/jquery-validation/js/jquery.validate.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>ams_components/assets/jquery-validation/js/additional-methods.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>ams_components/assets/bootstrap-wizard/jquery.bootstrap.wizard.min.js"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script type="text/javascript" src="<?php echo base_url();?>ams_components/assets/select2/select2.min.js"></script>
<!-- END PAGE LEVEL PLUGINS -->
