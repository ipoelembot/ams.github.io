...
<div>
    <h3 style="color: grey">Perorangan</h3>
</div>
                    ...
                    foreach ($list1 as $list) {
                        ...
                        elseif ($list->type == 'textbox') 
                        {
                            ...
                            <div class='col-md-".$list->col_length."' style='padding: 5px'>
                                <div class='form-group'>
                                  <label style='font-size: 12px'>".$list->list."</label>
                                  <textarea class='form-control' rows='2' id='".$list->id_list."' name='".$list->id_list."' style='resize: none'></textarea>
                                </div>
                            </div>
                            ";
                        }
                        elseif ($list->type == 'option' && $list->chain_flag != 'yes') 
                        {
                            ...
                            <div class='col-md-".$list->col_length."' style='padding: 5px'>
                                <label style='font-size: 12px'>".$list->list."</label>
                                <select class='select2' id='".$list->id_list."' name='".$list->id_list."' required='".$list->required_flag."'>
