<!-- ============================================= -->
<!-- Kontent Untuk Step 4 atau Step Data Fasilitas -->
<!-- ============================================= -->
<div class="row setup-content" id="step-4">
    <div class="col-xs-12">
        <div class="col-md-12">
        	<h3 class="block">Data Fasilitas <small style="font-size: 11px; color: #4AAAB2"><i>*) Mandatory. Harus Diisi!!</i></small></h3>
            <hr>
            <div class="col-md-12">
            ...
            foreach ($form4 as $list_form) {
                ...
                if ($list_form->id_switch == 'FD') {$idFass = '1';}
                    elseif ($list_form->id_switch == 'LC') {$idFass = '2';}
                        elseif ($list_form->id_switch == 'BG') {$idFass = '3';}
                echo "<input type='hidden' id='idFass' name='idFass' value='".$idFass."'>";            
