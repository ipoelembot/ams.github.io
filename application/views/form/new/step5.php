<!-- ========================================== -->
<!-- Kontent Untuk Step 5 atau Step Data Agunan -->
<!-- ========================================== -->

<div class="row setup-content" id="step-5">
    <div class="col-xs-12">
        <div class="col-md-12">
        	<h3 class="block">Data Agunan <small style="font-size: 11px; color: #4AAAB2"><i>*) Mandatory. Harus Diisi!!</i></small></h3>
            <hr>
            <div class="col-md-12">
                ...
                elseif ($list_form->type == 'select' && $list_form->chain_flag == 'Y') {
                    ...
                    } elseif ($count > 1) 
                    {
                        ...
                        "
                            <div style='padding: 5px;' class='form-group col-md-".$list_form->col_length."'>
                                <label style='font-size:12px'>".$list_form->list."<span class='required' style='color:red'>".$req."</span></label>
                                <select style='font-size:12px' class='form-control select2me' id='".$list_form->id_list."' name='".$list_form->id_list."' required='".$list_form->required_flag."'>
                ...
                elseif ($list_form->type == 'textarea') {
                    ...
                    "
                        <div style='padding: 5px;' class='form-group col-md-".$list_form->col_length."'>
                            ...
                            <textarea rows='2' style='resize: none; font-size:12px; text-transform:uppercase' class='form-control' id='".$list_form->id_list."' name='".$list_form->id_list."' required='".$list_form->required_flag."'></textarea>
                        </div>
                    ";
                }
            }
