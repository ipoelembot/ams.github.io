<!-- ============================================= -->
<!-- Kontent Untuk Step 6 atau Step Data Penjamin  -->
<!-- ============================================= -->

<div class="row setup-content" id="step-6">
    <div class="col-xs-12">
        <div class="col-md-12">
            <h3 class="block">Data Penjamin <small style="font-size: 11px; color: #4AAAB2"><i>*) Mandatory. Harus Diisi!!</i></small></h3>
            <hr>
            <div class="col-md-12">
                <input class="btn btn-success btn-md pull-right" type="submit" name="submit" value="Simpan">
            </div>
            <?php
