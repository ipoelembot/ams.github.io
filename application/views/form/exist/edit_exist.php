...
<form action="<?php echo base_url().'perorangan/simpanData/'.$id; ?>" method="post" id="formedit">
        ...
        <div class="box box-warning ">
            <div class="box-body">
                <div class="wizard-pane" role="tabpanel">
                    ...
                    <div class="wizard-buttons">
                        <button type="button" class="btn btn-previous">Previous</button>
                        <button type="submit" name="save" class="btn btn-primary btn-submit">Save/Update</button> 
                    </div>
